...
{
    if (inString == "rl-bab-dqn")
        return TSPTW_DP::RL_BAB;
    if (inString == "rl-ilds-dqn")
        return TSPTW_DP::RL_DQN;
    if (inString == "rl-rbs-ppo")
        return TSPTW_DP::RL_PPO;
    if (inString == "nearest")
        return TSPTW_DP::NN_HEURISTIC;
